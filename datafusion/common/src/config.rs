...
config_namespace! {
    ...
    pub struct OptimizerOptions {
        ...
        /// Min target partition size in bytes to perform file scan repartitioning.
        pub repartition_file_range_min_size: usize, default = 10 * 1024 * 1024

        /// Should DataFusion repartition data using the join keys to execute joins in parallel
        /// using the provided `target_partitions` level"
        pub repartition_joins: bool, default = true

        /// When set to true, file groups will be repartitioned to acieve maximum parallelism.
