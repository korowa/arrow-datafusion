...
fn optimize_partitions(
    ...
    repartition_file_range_min_size: usize,
        ...
        let children = plan
            ...
            .map(|(idx, child)| {
                ...
                optimize_partitions(
                    ...
                    repartition_file_range_min_size,
                )
            })
            .collect::<Result<_>>()?;
...
impl PhysicalOptimizerRule for Repartition {
    fn optimize(
        ...
        let repartition_file_range_min_size =
            config.optimizer.repartition_file_range_min_size;
...
mod tests {
    ...
    macro_rules! assert_optimized {
        ...
        ($EXPECTED_LINES: expr, $PLAN: expr, $TAGRET_PARTITIONS: expr, $REPARTITION_FILE_SCANS: expr, $REPARTITION_FILE_RANGE_MIN_SIZE: expr) => {
            ...
            config.optimizer.repartition_file_range_min_size = $REPARTITION_FILE_RANGE_MIN_SIZE;
